...
[![x-cmd/install — rpi-imager Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/rpi-imager.svg?lang=zh)](https://x-cmd.com/install/rpi-imager)
...
合计: **236,713** 行代码（覆盖前 5 种语言、共 **544** 个文件）。
...
- **Star**: 2,613 · **Fork**: 449 · **开放 issue**: 1,230 · **贡献者**: 91

## 累计统计

- **发布数**: 40 · **已合并 PR**: 368 · **开放 PR**: 21 · **已关闭 issue**: 1131 · **开放 issue**: 99 · **提交数**: 2081
...
_数据快照: `data/card/260924.yml` · 2026-09-24T04:57:04Z._
